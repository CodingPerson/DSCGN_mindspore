...
def main():
    ...
    parser.add_argument('--dataset_dir', default='../datasets/profession-page/',
    ...
    parser.add_argument('--web_file', default='web.txt',
                        help='test corpus to conduct model predictions (under dataset directory); one document per line')
    parser.add_argument('--web_label_file', default='web_labels.txt',
                        help='test corpus ground truth label; if provided, model will be evaluated during self-training')
    parser.add_argument('--gold_label_file', default='gold_labels.txt',
                        help='test corpus ground truth label; if provided, model will be evaluated during self-training')
